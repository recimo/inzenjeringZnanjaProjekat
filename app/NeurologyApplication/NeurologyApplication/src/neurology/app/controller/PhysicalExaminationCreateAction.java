...
public class PhysicalExaminationCreateAction {
	public void action(PhysicalExamination newPhysicalExamination,boolean musclesRecognition,
			boolean abnormalInvoluntaryMovements, boolean seizures, boolean problemsWithMovement,
			String visualAcuity, String musclesStrength, boolean disturbanceOfMemory, boolean dizziness,
			boolean focalWeakness, boolean kneePain, boolean hipPain, boolean backPain, boolean legPain,
			boolean chestPain, boolean lossOfSensation, boolean apraxia, Examination examination) {
