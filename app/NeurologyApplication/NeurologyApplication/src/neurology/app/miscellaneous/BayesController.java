...
//									"stroke_bayes" };
	...
	public DiagnosisModel CreateBayesNet(String bajesFileName, ArrayList<Symptom> symptoms)
...
//			}
		...
		// adding an evidence
		// namestaju se simptomi koji ulaze u obzir iz liste simptoma koja je
		// popunjena...
		// mora ici for / foreach petlja...
		bajesFileName = bajesFileName.substring(0, bajesFileName.length() - 6);
